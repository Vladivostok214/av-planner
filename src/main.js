...
window.formatScript = (cmd) => {
    if (cmd === 'scene') {
        ...
        node.className = 'my-8 border-t-2 border-dashed border-brand-accent/30 pt-4 font-bold text-brand-accent uppercase tracking-[0.3em] text-center text-[9px]';
