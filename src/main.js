...
const renderApp = () => {
    ...
    if (window.appState.view === 'dashboard') {
        ...
        const syncAction = async () => {
            ...
            if (window.appState.showSettingsModal) {
            ...
            if (window.appState.showSettingsModal) { window.appState.showSettingsModal = false; renderApp(); }
        };
